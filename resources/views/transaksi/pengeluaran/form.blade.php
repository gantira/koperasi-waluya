<div class="row">
    <div class="col-md-12">
       <div class="form-group">
        ...
        <div class="form-group">
            <label>Jumlah</label>
            {!! Form::text('keluar', null, ['class'=>'form-control border-input', 'placeholder'=>'Jumlah', 'id'=>'jumlah']) !!}
            <span class="help-block {{ $errors->has('keluar') ? 'has-error' : '' }}">
                <small>{{ $errors->first('keluar') }}</small>
            </span>
        </div>
