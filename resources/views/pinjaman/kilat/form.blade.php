    ...
    <div class="col-md-12">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <span class="help-block {{ $errors->has('administrasi_kilat') ? 'has-error' : '' }}">
...
<script type="text/javascript">
    ...
    function hitung(jumlah) {
        document.getElementById('administrasi').value = {{ $setting->administrasi_kilat }};
        document.getElementById('provisi').value = (jumlah * {{ $setting->provisi_kilat/100 }}).toFixed(0);
        document.getElementById('pemupukan').value = (jumlah * {{ $setting->pemupukan_kilat/100 }}).toFixed(0);
        document.getElementById('jasa').value = {{ $setting->jasa_kilat }};
    }

    function show(nomor) {
        var url = '{{ url('kilat') }}/'+nomor;
